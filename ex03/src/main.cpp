...
/*   Updated: 2025/03/12 17:18:06 by sadoming         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main()
{
	...
	*/
	...
	// Create forms with the intern
	std::cout << std::endl;
	std::cout << "Creating forms with the intern" << std::endl;
	/**/
	AForm	*shrubberyForm = intern.makeForm("shrubbery creation", ".");
	AForm	*robotomyForm = intern.makeForm("robotomy request", "Bender");
	AForm	*presidentialForm = intern.makeForm("presidential pardon", "Zaphod Beeblebrox");
	/**/
	std::cout << std::endl;

	// Try to create a form with an invalid name
	std::cout << "Try to create a form with an invalid name" << std::endl;
	/**/
	try
	{
	...
	// Sign and execute the forms!
	std::cout << std::endl;
	std::cout << "Singing and executing forms" << std::endl;
	/**/
	gilbert.signForm(shrubberyForm);
	gilbert.signForm(robotomyForm);
	gilbert.signForm(presidentialForm);
	/**/
	/**/
	gilbert.executeForm(*shrubberyForm);
	gilbert.executeForm(*robotomyForm);
	gilbert.executeForm(*presidentialForm);
	/**/
	/******************* */
	/******************* */	/******************* */
